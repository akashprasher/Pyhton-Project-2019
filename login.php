...
<div class="center">
<img src="elogin.png" alt="contact" width="189px" height="57.2px"></img>
<h4 style="color: green">Email</h4>
<input type="Email" placeholder="Enter your email" name="email">
<h4 style="color: green">Password</h4>
<input  type="Password" placeholder="Password" name="password">
<br><br>
<button style="color: green">Login</button><br>
<input type="submit" name="submit">
<input type="text" name="txt">
<h6>Don't Have an Account, Please Signup</h6><button style="color: green">Signup</button>
</div>
</form>
